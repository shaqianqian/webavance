...
function Col(balise, jour, largeur) {
    this.balise = balise;
    this.jour = jour;
}
...
function construitColonnesJours() {
...
for (var i = 0; i < lesSoutenances.length; i++) {
    ...
    div_panel.className = "panel "+CouleursPanel[lesSoutenances[i].specialite];

    var div_head = document.createElement("div");
    div_head.className = "panel-heading";
    var b = document.createElement("b");
    var temp = document.createTextNode(lesSoutenances[i].debut);
    ...
    div_body.appendChild(document.createTextNode(lesSoutenances[i].etudiant));
    div_body.appendChild(document.createElement("br"));
    div_body.appendChild(document.createTextNode(lesSoutenances[i].tuteur));
    div_body.appendChild(document.createElement("br"));
    div_body.appendChild(document.createTextNode(lesSoutenances[i].encadrant));
    ...
    for (var j = 0; j < 4; j++) {
        ...
        if (lesSoutenances[i].jour == Cols[j].jour) {
...
for (var j = 0; j < 4; j++) {
    ...
    element.appendChild(Cols[j].balise);
